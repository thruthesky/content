---
name: create-banner
description: "Create a banner ad on a Korea SNS sub-site. Admin API key required. Example: '/korea:create-banner apple.withcenter.com Header banner for Spring Sale, runs April 20 to May 20, click goes to example.com'. Use for creating banners, banner ads, header banner, sidebar banner, forum banner."
---
...
/korea:create-banner bangphil.com Forum banner in Restaurants category, title "Yakimix Buffet", runs April 20 – May 20
...
| `subtitle` | optional | Sub-line for longer labels |
...
| `forum` | `400x400` (rendered at 100×100 square) |
...
For forum banners add `--category-id`. Advertiser contacts go through `--contact-telegram`, `--contact-phone`, etc.
